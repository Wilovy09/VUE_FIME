<template>
    <section  class="max-w-[700px] m-auto mt-4 p-4 rounded-xl">
        <img class="min-w-[100%] rounded-xl" src="/libros.jpg" alt="IMG_Libros"/>
        <h2 class="font-bold text-2xl text-center mt-4">Acerca de nosotros</h2>
        <p class="mt-4">
